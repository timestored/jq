...
public class PrdOp extends MonadReduceToObject {
	public static PrdOp INSTANCE = new PrdOp();
	@Override public String name() { return "prd"; }

	@Override public Object ex(BooleanCol a) 	{ return ex(CastOp.CAST.i(a)); }
	@Override public Object ex(CharacterCol a){ throw new TypeException(); }
	...
	@Override public Object ex(IntegerCol a)	{ return to(a, a.over(1, (b, c) -> c == SpecialValues.ni ? b : b*c)); }
	@Override public Object ex(LongCol a) 		{ return to(a, a.over(1, (b, c) -> c == SpecialValues.nj ? b : b*c)); }
	@Override public Float ex(FloatCol a) 		{ return a.over(1, (b, c) -> Float.isNaN(c) ? b : b*c); }
	@Override public Double ex(DoubleCol a) 	{ return a.over(1, (b, c) -> Double.isNaN(c) ? b : b*c); }
